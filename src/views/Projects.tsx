    ...
    <div class="section hero-section">
        <div class="container _100px-margin">
            <h1 class="hero-text page-title">
                <strong class="bold-text-16">Our projects</strong>
            </h1>
            <div class="sideflex categories">
                <a href="/projects" aria-current="page" class="project-categories-link w-inline-block w--current">
                ...
                <div class="w-dyn-list">
                    ...
                    ${categories?.map((category: any, key: any) => {
                        ...
                        <div key=${key} role="listitem" class="w-dyn-item">
                            <a href="/category/${category.fields?.Slug || category.id}" class="project-categories-link w-inline-block">
